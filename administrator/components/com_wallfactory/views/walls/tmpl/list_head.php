...
<th class="nowrap hidden-phone center" style="width: 1%">
    <?php echo JHtml::_('searchtools.sort', 'Posts', 'posts', $this->listDirn, $this->listOrder); ?>
</th>
...
<th class="nowrap hidden-phone" style="width: 10%">
    <?php echo JHtml::_('searchtools.sort', 'Owner', 'name', $this->listDirn, $this->listOrder); ?>
</th>
