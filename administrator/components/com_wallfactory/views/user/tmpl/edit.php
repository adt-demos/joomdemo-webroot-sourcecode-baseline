...
<div class="row-fluid row">
    ...
    <div id="j-main-container"
        ...
        <form action="<?php echo WallFactoryRoute::view($this->getName() . '&layout=edit&id=' . (int)$this->item->user_id); ?>"
            ...
            <div class="row-fluid">
                ...
                <div class="span4">
                    <h2><?php echo WallFactoryText::_($this->getName() . '_fieldset_avatar'); ?></h2>
