...
namespace ThePhpFactory\Joomla;
...
class About
{
    ...
    public function __construct($extension)
    {
        ...
        $this->remoteManifest = $this->readRemoteManifest();
        $this->localManifest = \Joomla\CMS\Installer\Installer::parseXMLInstallFile($this->getLocalManifestPath());
        $this->layout = new \Joomla\CMS\Layout\FileLayout('layout', __DIR__);
    }
    ...
    private function readRemoteManifest()
    {
        return @simplexml_load_string($this->fetchUrl($this->getRemoteManifestUrl()));
    }
}
