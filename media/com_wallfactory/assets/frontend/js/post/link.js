jQuery(document).ready(function ($) {
    var $template = $('#media-link-template');
    var config = $('div.submit-post-buttons').data('config');

    $(document).on('media_button_link', 'div.submit-post-buttons', function () {
    ...
    // Preview.
    $(document).on('change', 'div[data-media="link"] input[type="text"]', function () {
        var $element = $(this)
